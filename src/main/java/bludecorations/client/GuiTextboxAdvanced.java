...
public class GuiTextboxAdvanced extends Gui
{
    /**
    ...
    private int errorColor = 1710731;

    /** True if this textbox is visible */
    private boolean visible = true;

    public GuiTextboxAdvanced(FontRenderer par1FontRenderer, int x, int y, int width, int height)
    {
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            int i = this.isInvalid ? this.errorColor : this.isEnabled ? this.enabledColor : this.disabledColor;
    ...
    public void setInvalid(boolean par1)
    {
        this.isInvalid = par1;
    }
